...
function Overview(){
  ...
  return <div className='space-y-4'>
    {upstreamStale && <div className='card border border-red-500/40 bg-red-900/20'><div className='font-semibold text-red-300'>Upstream Sync Alarm</div><div className='text-sm text-red-200'>Upstream source count 0 ama efektif agent/skill var. Endpoint mapping veya payload parse kontrol edilmeli.</div></div>}
